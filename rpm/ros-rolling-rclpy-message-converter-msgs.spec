...
%global pkg_name rclpy_message_converter_msgs
%global normalized_pkg_name %{lua:return (string.gsub(rpm.expand('%{pkg_name}'), '_', '-'))}

Name:           ros-rolling-rclpy-message-converter-msgs
Version:        2.0.1
Release:        3%{?dist}
...
%changelog
* Fri Mar 22 2024 Martin Günther <martin.guenther@dfki.de> - 2.0.1-3
